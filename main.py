...
class FireControlApplication:
    def __init__(self, window):
        ...
        # Create GUI elements
        self.label = tk.Label(self.frame, text="Artificial Intelligence Supported Fire Control")
        self.label.pack(pady=10)

        self.photo_label = tk.Label(self.frame, text="Select a photo for Fire Control")
